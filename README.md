# HOOPIUM 🐸 — solana token risk scanner

Terminal-styled scanner: paste a Solana token **contract address (CA)** in the chat and HOOPIUM
...
The report also includes a **META FIT** section: HOOPIUM pulls the tokens currently live/trending
...
4. Pin HOOPIUM to the toolbar. Click it, paste a CA, hit **scan**.
